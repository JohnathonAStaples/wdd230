...
function displayResults(fruitData) {
    ...
    fruitLabelEle1.innerHTML = "Fruit "
    ...
    fruitLabelEle2.innerHTML = "Fruit "
    ...
    fruitLabelEle3.innerHTML = "Fruit "
...
function displayOutput(list = fruits){
    ...
    personInfo.innerHTML = "Personal Info and Request"
    ...
    thanksMessage.innerHTML = "thank you"
